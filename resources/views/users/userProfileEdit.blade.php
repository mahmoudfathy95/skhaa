                        ...
                        <div class="form-body">
                            ...
                            <div class="row col-sm-12">
                                <div class="col-sm-3">
                                    ...
                                    <input class="form-control" name="name" value="{{$user->name}}" {{$disabled}} required="">
                                </div>
                                
                                <div class="col-sm-3">
                                    <label class="control-label">التليفون</label>
                                    <input class="form-control" name="phone" value="{{$user->phone}}" {{$disabled}} required="">
                                </div>
                                
                                <div class="col-sm-3">
                                    <label class="control-label"> الرقم السري</label>
                                    <input class="form-control" name="password" value="@if($status == 'edit' || $status == 'show'){{trim(decrypt($user->encrypted_password))}}@endif" {{$disabled}} required="">
                                </div>
