        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><b>بيانات الأقسام</b><a href="{{url('categories/create')}}" class="btn btn-primary" style="float:left;">انشاء</a></h3>
                ...
                <div class="card-content collapse show">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table mb-0 table-centered table-bordered" style="width: 100%" id="categories-table">
