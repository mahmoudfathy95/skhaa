...
@if(auth()->user()->hasRole('owner') || auth()->user()->hasRole('super_admin'))
            ...
            <li class="nav-item has-sub" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="javascript:;" ><i class="ft-home"></i><span class="menu-title" >العروض </span></a>
                <ul class="menu-content">
                    ...
                    <li ><a class="menu-item" href="{{url('backend/offersslider')}}" data-action="offersslider.index" > سلايدر العروض
                        </a>
                    </li>
            ...
            <li class="nav-item has-sub" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="javascript:;" ><i class="ft-home"></i><span class="menu-title" >المنتجات </span></a>
                <ul class="menu-content">
                    ...
                    <li ><a class="menu-item" href="{{url('backend/newproducts')}}" data-action="newproducts.index" > أحدث المنتجات
                        </a>
                    </li>
                </ul>
            </li>
     ...
     @else
             ...
             <li class="nav-item has-sub" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="javascript:;" ><i class="ft-home"></i><span class="menu-title" >المنتجات </span></a>
                <ul class="menu-content">
                    ...
                    <li ><a class="menu-item" href="{{url('newproducts/edit/branch')}}" data-action="newproducts.index" > أحدث المنتجات
                        </a>
                    </li>
            ...
            <li class="nav-item has-sub" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="javascript:;" ><i class="ft-home"></i><span class="menu-title" >العروض </span></a>
                <ul class="menu-content">
                    ...
                    <li ><a class="menu-item" href="{{url('ouroffers/edit/branch')}}" data-action="ouroffers.index" > عروضنا
                        </a>
                    </li>
                </ul>
            </li>
