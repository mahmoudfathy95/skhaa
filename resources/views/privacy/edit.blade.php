        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"><b>من نحن</b><a href="{{url('backend/privacy')}}" class="btn btn-primary" style="float:left;">رجوع</a></h4>
                ...
                <div class="card-content collapse show">
                    ...
                    <form action="{{$action}}" method="POST" class="form-horizontal" id="create_form" enctype="multipart/form-data">
                        <div class="form-body">
                            ...
                            @if($status == 'edit')
                                <input type="hidden" name="setting_id" value="{{$privacy->id}}" />
                            @endif
                            ...
                            <div class="row col-sm-12">
                                <div class="col-sm-6">
                                    ...
                                    <textarea name="data_ar" class="form-control required" required="">{{$privacy->data_ar}}</textarea>
                                </div>
                                <div class="col-sm-6">
                                    <label class="control-label">الوصف بالانجليزى </label>
                                    <textarea name="data" class="form-control required" required="">{{$privacy->data}}</textarea>
                                </div>
                            ...
                            <div class="image_cont">
                                @if($status == 'edit')
                                    ...
                                    <input type="hidden" id="image" name="image" value="{{$privacy->image}}"  />
                            ...
                            <div class="row col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <span id="uploaded_image">
                                        ...
                                        <img src="{!! ($status == 'edit')? 'uploads/' : '' !!}{{$privacy->image}}" class="img-thumbnail" width="300" />
