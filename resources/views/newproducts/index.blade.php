@extends('layout')
@section('title','بيانات أحدث المنتجات')
@section('content')
<?php
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><b>بيانات المدن</b><a href="{{url('newproducts/create')}}" class="btn btn-primary" style="float:left;">انشاء</a></h3>
