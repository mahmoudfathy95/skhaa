...
@section('title','Create New StaticPage Language | StaticPages Data Languages')
@section('content')
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('backend/staticpages/languages/'.$staticpage->id)}}">StaticPages Languages</a>
                    </li>
                    <li class="breadcrumb-item">Create StaticPages Language Data
                    </li>
