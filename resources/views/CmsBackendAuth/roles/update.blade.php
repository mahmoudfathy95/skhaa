        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">تعديل تصريح
                    </li>
                ...
                <div class="card-content collapse show">
                    ...
                    <form class="form-horizontal" role="form" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="name" placeholder="{{trans('cms-backend-auth.enter-role')}}" value="{{$role->name}}" required="">
                            </div>
                        </div>
