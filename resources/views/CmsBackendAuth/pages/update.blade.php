...
<div class="row">
    <h4 class="header-title m-t-0 m-b-30">{{trans('cms-backend-auth.update-page')}}</h4>
    ...
    <ul class="breadcrumb">
        ...
        <li>{{trans('cms-backend-auth.update')}}</li>
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal" role="form" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="name" value="{{$page->name}}" placeholder="{{trans('cms-backend-auth.enter-user-name')}}" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">{{trans('cms-backend-auth.link')}}</label>
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="link" value="{{$page->link}}" placeholder="{{trans('cms-backend-auth.enter-link')}}" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">{{trans('cms-backend-auth.module')}}</label>
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="module" value="{{$page->module}}" placeholder="{{trans('cms-backend-auth.enter-module')}}" required="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">{{trans('cms-backend-auth.action')}}</label>
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="module" value="{{$page->action}}" placeholder="{{trans('cms-backend-auth.enter-module')}}" required="">
                            </div>
                        </div>
