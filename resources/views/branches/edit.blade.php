        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"><b>تعديل الفرع</b><a href="{{url('backend/branches')}}" class="btn btn-primary" style="float:left;">رجوع</a></h4>
                        ...
                        <div class="form-body">
                            ...
                            <div class="row col-sm-12">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="email" class="form-control" name="branch_email" value="{{$branch->branch_email}}" required="">
                                </div>
                            ...
                            <div class="row col-sm-12">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="form-control" name="longtitude" value="{{$branch->longtitude}}" required="">
                                </div>
                                
                                <div class="col-sm-3">
                                    <label class="control-label"> lat </label>
                                    <input type="text" class="form-control" name="lat" value="{{$branch->lat}}" required="">
                                </div>
                            ...
                            <div class="row col-sm-12">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="form-control" name="street" value="{{$branch->street}}" required="">
                                </div>
                                
                                <div class="col-sm-3">
                                    <label class="control-label"> وصف الشارع </label>
                                    <input type="text" class="form-control" name="street_description" value="{{$branch->street_description}}" required="">
                                </div>
