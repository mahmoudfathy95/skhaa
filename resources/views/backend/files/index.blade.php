...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12">
        <div class="media width-250 float-right">
            <a  class="btn btn-success round btn-min-width mr-1 mb-1" href="{{url('backend/services/create')}}">انشاء</a>
        </div>
    </div>
</div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('backend/services/edit/'.$row->id)}}" class=" btn btn-xs btn-outline btn-primary"  id="stepEdit"><i class="fa fa-paste"></i> تعديل</a>
                                      

                                        {!!Themes::deleteRow($row->id, url('backend/services//delete'),[])!!}
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
