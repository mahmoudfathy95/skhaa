...
@section('title','Create New Filters Language | Filters Data Languages')
@section('content')
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('backend/options/languages/'.$option->id)}}">Filters Languages</a>
                    </li>
                    <li class="breadcrumb-item">Create Filters Language Data
                    </li>
