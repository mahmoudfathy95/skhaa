            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    <div class="row col-sm-12">
                        ...
                        <input type="text" class="form-control" name="name_ar" value="{{$filter->name_ar}}" required="">
                    </div>
                        <div class="col-sm-4">
                        <label class="control-label">الاسم بالانجليزى </label>
                        <input type="text" class="form-control" name="name_en" value="{{$filter->name_en}}" required="">
                    </div>
