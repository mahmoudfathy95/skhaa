            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    <div class="row col-sm-12">
                        ...
                        <input type="text" class="form-control" name="name_ar" value="{{$volume->name_ar}}" required="">
                    </div>
                        <div class="col-sm-4">
                        <label class="control-label">الاسم بالانجليزى </label>
                        <input type="text" class="form-control" name="name_en" value="{{$volume->name_en}}" required="">
                    </div>
