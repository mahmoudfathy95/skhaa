                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="meta_description" placeholder="Please Enter Meta Description" class="form-control" required=""> {{Functions::issetPost('meta_description', $staticpageLanguage->meta_description)}} </textarea>
                        </div>
                    </div>
             <div class="form-group">
                ...
                <input type="hidden" name="media_id" value="{{Functions::issetPost('media_id', $staticpage->image_id)}}">
                <div class="form-group">
