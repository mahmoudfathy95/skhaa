            ...
            <div class="card-content">
                <div class="media align-items-stretch">
                    ...
                    <div class="p-2 bg-gradient-x-primary white media-body">
                        <h5>Total Sales</h5>
                        <h5 class="text-bold-400 mb-0"><i class="feather icon-plus"></i> {{$total}}</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-content">
                <div class="media align-items-stretch">
                    ...
                    <div class="p-2 bg-gradient-x-primary white media-body">
                        <h5>Orders</h5>
                        <h5 class="text-bold-400 mb-0"><i class="feather icon-plus"></i> {{$count}}</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-content">
                <div class="media align-items-stretch">
                    ...
                    <div class="p-2 bg-gradient-x-primary white media-body">
                        ...
                        <h5 class="text-bold-400 mb-0"><i class="feather icon-plus"></i> {{$avarege}}</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-content">
                <div class="media align-items-stretch">
                    ...
                    <div class="p-2 bg-gradient-x-primary white media-body">
                        <h5>Items Sold</h5>
                        <h5 class="text-bold-400 mb-0"><i class="feather icon-plus"></i> {{$items}}</h5>
                    </div>
                </div>
            </div>
        </div>
